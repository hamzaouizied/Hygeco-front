...
<template>
          ...
          <div class="howwork-content">
            ...
            <div class="howit-work-info">
              <div class="howit-item wow fadeInUp" data-wow-delay="0.7" style="
                ...
                <p class="pra">
                  Que ce soit pour un nettoyage régulier, ménage de printemps, postconstruction ou déménagement, nous
                  sommes là pour vous.
                </p>
              </div>
            </div>
  ...
  <div class="container">
    <img decoding="async"
      src="https://www.4damstheme.com/clenis/wp-content/plugins/clenis-toolkit/widgets/img/icon/flower.png"
      alt="How It Works" class="follower-section" style="position: relative; left: 30px; top: -27px" />
    <div class="row justify-content-lg-between justify-content-center">
      <div class="col-lg-5 col-md-7">
        <div class="howwork-content">
          <div class="cmn-section-title">
      ...
      <div class="col-lg-7">
        <div class="work-thumb">
          <img decoding="async" src="../../assets/img/33.png" alt="How It Works"
            style="width: 90%; border-radius: 60px" />
        </div>
      </div>
    </div>
    <img decoding="async"
                      ...
                      <div class="clean-form-grp">
                        <p>
                          ...
                          <span class="wpcf7-form-control-wrap" data-name="text-454"><input size="40"
                              ...
                              aria-invalid="false" placeholder="Nom" value="" type="text" name="text-454" /></span>
                        </p>
                      </div>
                    </div>
                    <div class="col-lg-6 col-md-6">
                      <div class="clean-form-grp">
                        <p>
                          ...
                          <span class="wpcf7-form-control-wrap" data-name="text-454"><input size="40"
                              class="wpcf7-form-control wpcf7-text wpcf7-validates-as-required" aria-required="true"
                              aria-invalid="false" placeholder="Prénom" value="" type="text" name="text-454" /></span>
                        </p>
                      </div>
                    </div>
                    <div class="col-lg-6 col-md-6">
                      <div class="clean-form-grp">
                        <p>
                          ...
                          <span class="wpcf7-form-control-wrap" data-name="email-332"><input size="40"
                              ...
                              aria-required="true" aria-invalid="false" placeholder="Adresse courriel" value=""
                              type="email" name="email-332" /></span>
                        </p>
                      </div>
                    </div>
                    <div class="col-lg-6 col-md-6">
                      <div class="clean-form-grp">
                        <p>
                          ...
                          <span class="wpcf7-form-control-wrap" data-name="email-332"><input size="40"
                              class="wpcf7-form-control wpcf7-email wpcf7-validates-as-required wpcf7-text wpcf7-validates-as-email"
                              aria-required="true" aria-invalid="false" placeholder="Cellulaire" value="" type="email"
                              name="email-332" /></span>
                        </p>
                      </div>
                    </div>
                        ...
                        <p>
                          ...
                          <span class="wpcf7-form-control-wrap" data-name="textarea-35">
                            <textarea cols="40" rows="10"
                              ...
                              aria-invalid="false" placeholder="Nous sommes à votre écoute..."
                              name="textarea-35"></textarea>
                          </span>
                        </p>
                      </div>
                    </div>
