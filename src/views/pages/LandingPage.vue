...
<template>
   <navbar 
        ...
        :dark-mode="true" />
<div  
        class="page-header position-relative" :style="{
            backgroundImage: 'url(' + existingSlides[currentIndex].imageUrl + ')',
            ...
            <div class="row">
                <div class="col-md-6 mt-4">
                    <h3 class="text-white" style="font-size: 2.5rem; color: #000000">
                        {{ existingSlides[currentIndex].text }}
                    </h3>
                    <router-link 
                        :to="{ name: 'Signin Basic' }" class="mb-0 btn btn-sm me-1"
                ...
                <div class="card flex-grow-1 mr-3">
                    <div class="p-3 pb-0 card-header d-flex">
                        ...
                        <div class="nav-wrapper position-relative ms-auto w-50">
                            <ul class="p-1 nav nav-pills nav-fill" role="tablist">
                                <li class="nav-item">
                                    <a 
                                        class="px-0 py-1 mb-0 nav-link active" data-bs-toggle="tab" href="#cam1"
                                        role="tab" aria-controls="cam1" aria-selected="true">Ménage</a>
                                </li>
                                <li class="nav-item">
                                    <a 
                                        class="px-0 py-1 mb-0 nav-link" data-bs-toggle="tab" href="#cam2" role="tab"
                                        aria-controls="cam2" aria-selected="false">Buandrie</a>
                                </li>
                            </ul>
                        </div>
                    </div>
                    <div class="p-3 mt-2 card-body">
                        <div id="v-pills-tabContent" class="tab-content">
                            <div 
                                id="cam1"
                                class="tab-pane fade show position-relative active height-400 border-radius-lg opacity-6 "
                            ...
                            ></div>
                            <div 
                                id="cam2" class="tab-pane fade position-relative height-400 border-radius-lg opacity-6"
...
<div class="container">
    ...
    <div class="row mt-4">
        ...
        <div class="card-body">
            ...
            <p class="card-text">Indiquez-nous ce que vous souhaitez faire nettoyer, et nous vous proposerons les meilleurs prix du marché.</p>
        ...
        <div class="col-lg-4 col-md-6 mb-4">
            ...
            <div class="card-body">
                ...
                <p class="card-text">Explorez notre outil de planification en ligne pour sélectionner un horaire qui correspond parfaitement à votre emploi du temps.</p>
                <a href="#" class="btn btn-primary">Read more</a>
            </div>
            </div>
        </div>
        ...
        <div class="card-body">
            ...
            <p class="card-text">Saisissez la Sérénité d'une Maison Parfaitement Propre, Où Chaque Coin Brille de Fraîcheur.Profitez d'une Maison Propre</p>
            <a href="#" class="btn btn-primary">Read more</a>
        </div>
    </div>
        </div>
...
<div class="container">
    ...
    <div class="row mt-4">
        ...
        <div class="card-body">
            ...
            <p class="card-text">Indiquez-nous les services de lessive dont vous avez besoin, et nous vous proposerons les meilleurs prix du marché.</p>
            <a href="#" class="btn btn-primary">Read more</a>
        </div>
    </div>
        </div>
        <div class="col-lg-4 col-md-6 mb-4">
            ...
            <div class="card-body">
                <h5 class="card-title">Réservez Votre Rendez-vous.</h5>
                <p class="card-text">Explorez notre outil de planification en ligne pour choisir un créneau qui correspond parfaitement à votre emploi du temps.</p>
                <a href="#" class="btn btn-primary">Read more</a>
            </div>
            </div>
        </div>
        ...
        <div class="card-body">
            ...
            <p class="card-text">Immergez-vous dans le confort d'une garde-robe propre, où chaque vêtement se sent rafraîchi et prêt à être porté.</p>
            <a href="#" class="btn btn-primary">Read more</a>
        </div>
    </div>
        </div>
      ...
      <div class="col-md-12 mt-4">
        <div id="testimonialCarousel" class="carousel slide" data-bs-ride="carousel" style="background-color: transparent;">
          <div class="carousel-inner">
            <div v-for="(testimonial, index) in testimonialSlides" :key="index" class="carousel-item" :class="{ 'active': index === 0 }">
      ...
      <div id="carouselExampleIndicators" class="carousel slide" data-bs-ride="carousel">
        <div class="carousel-inner">
          ...
          <div class="carousel-item">
            <div class="row justify-content-center align-items-center">
              <div class="mb-4 col-lg-2 col-md-4 col-6">
                <img class="w-100 opacity-9" src="../../assets/img/logos/gray-logos/logo-pinterest.svg" alt="logo_nasa">
              </div>
            </div>
          </div>
          <div class="carousel-item">
          ...
          <div class="carousel-item">
            <div class="row justify-content-center align-items-center">
              <div class="mb-4 col-lg-2 col-md-4 col-6">
                <img class="w-100 opacity-9" src="../../assets/img/logos/gray-logos/logo-vodafone.svg" alt="logo_nasa">
              </div>
            </div>
          </div>
        </div>
