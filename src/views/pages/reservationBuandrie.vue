<template>
  ...
  <div class="container p-5">
    ...
    <div class="row">
      <div class="col-sm-8  form-section shadow-border booking-panel cardi">
...
<div class="form-check">
  ...
  <label class="form-check-label" for="move-out-move-in">
    Tapis
        ...
        <div class="cardii " style="width: 18rem;">
          <img src="../../assets/img/sac.jpeg" class="card-img-top" alt="Image description">
          <div class="card-body">
            <p class="card-text text-center" style="color: #30c7b5;">Sac Hygeco = *lb</p>
          </div>
        </div>
      ...
      <div class="col-sm-3 cardi" style="margin-left: 20px;">
