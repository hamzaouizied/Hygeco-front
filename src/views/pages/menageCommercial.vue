...
<template>
  ...
  <div class="page-header position-relative" :style="{
    backgroundImage: 'url(' + require('../../assets/img/400.png') + ')',
    ...
    <div class="container pb-10 pb-lg-9 pt-7 postion-relative z-index-2">
      <div class="row">
        <div class="mx-auto text-center col-md-6 mt-4">
          <h3 class="text-center" style="color: #30c7b5;">Menage Commercial </h3>
                      ...
                      <div class="clean-form-grp">
                        <p>
                          ...
                          <input v-model="form.nom_entreprise"
                            ...
                            placeholder="Nom de l'entreprise" type="text" name="nom_entreprise" /><span
                            v-if="errors.nom_entreprise" class="error">{{ errors.nom_entreprise }}</span>
                        </p>
                      </div>
                    </div>
...
.address-span {
  display: block;
  /* This makes each span take up the full width and ensures the margin applies correctly */
  margin-bottom: 10px;
  /* Adjust the value to control the space between spans */
}
